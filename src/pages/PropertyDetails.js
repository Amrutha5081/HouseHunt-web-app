    ...
    <div className='container mx-auto min-h-[800px] mb-14'>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='mb-4 lg:mb-0 flex gap-x-2 text-sm'>
          <div className='bg-violet-900 rounded-full text-white px-3 inline-block'>
            {property.type}
          </div>
      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        <div className='max-w-[768px]'>
          ...
          <div className='flex gap-x-6 text-violet-900 mb-6'>
        ...
        <div className='flex-1 w-full mb-8 bg-white border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
            ...
            <div className='flex gap-x-2'>
              <button
                className='bg-blue-900 hover:bg-violet-800 text-white rounded p-4 text-l w-full transition'
                type='submit'
              >
                Send message
              </button>
              <button className='border border-blue-800 text-violet-900 hover:border-purple-600 hover:text-purple-600 rounded p-4 text-m w-full transition'>
                Call
              </button>
            </div>
          </form>
